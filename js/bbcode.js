...
function AddCodeFromWindow( thecode ) {
    ...
    if ( typeof opener.document.selection !== "undefined" ) {
        ...
        textfield.value =
            textfield.value.substr( 0, start ) + thecode + textfield.value.substr( end );
        ...
        textfield.value =
            textfield.value.substr( 0, pos ) + thecode + textfield.value.substr( pos );
    }
}
