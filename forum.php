...
function boardmain()
{
    ...
    while ($dk = mysqli_fetch_array($kath)) {
        ...
        while ($db = mysqli_fetch_array($boards)) {
            ...
            if ($found) {
                $icon = '<img src="images/icons/boardicons/' . $writer . 'on.gif" alt="' .
                    $_language->module[ 'new_posts' ] . '">';
            } else {
...
function showboard($board)
{
    ...
    if ($anztopics) {
        ...
        while ($dt = mysqli_fetch_array($topics)) {
            ...
            if ($dt[ 'sticky' ]) {
                $onicon =
                    '<img src="images/icons/foldericons/newsticky.gif" alt="' . $_language->module[ 'sticky' ] . '">';
                $officon =
                    '<img src="images/icons/foldericons/sticky.gif" alt="' . $_language->module[ 'sticky' ] . '">';
                $onhoticon =
                    '<img src="images/icons/foldericons/newsticky.gif" alt="' . $_language->module[ 'sticky' ] . '">';
                $offhoticon =
                    '<img src="images/icons/foldericons/sticky.gif" alt="' . $_language->module[ 'sticky' ] . '">';
                ...
                $onicon =
                    '<img src="images/icons/foldericons/newfolder.gif" alt="' . $_language->module[ 'new_posts' ] .
                    '">';
                $officon =
                    '<img src="images/icons/foldericons/folder.gif" alt="no ' . $_language->module[ 'new_posts' ] .
                    '">';
                $onhoticon =
                    '<img src="images/icons/foldericons/newhotfolder.gif" alt="' . $_language->module[ 'new_posts' ] .
                    ' [' . $_language->module[ 'popular' ] . ']">';
                $offhoticon =
                    '<img src="images/icons/foldericons/hotfolder.gif" alt="no ' . $_language->module[ 'new_posts' ] .
                    ' [' . $_language->module[ 'popular' ] . ']">';
            }

            if ($dt[ 'closed' ]) {
                $folder =
                    '<img src="images/icons/foldericons/lockfolder.gif" alt="' . $_language->module[ 'closed' ] . '">';
            } elseif ($dt[ 'moveID' ]) {
