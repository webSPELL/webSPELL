            ...
            if ($autoresize == 1) {
                ...
                if ($picinfo[0] > $size_l || $picinfo[1] > $size_h) {
                    $content = str_ireplace(
                        '[img]' . $teil[2] . '[/img]',
                        '[url=' . $teil[2] . ']' .
                        '<img src="' . fixJavaEvents($teil[2]) . '" width="' . $picsize_l .
                        '" alt="' . $teil[2] . '" /><br />([i]' . $_language->module['auto_resize'] .
                        ': ' . $picinfo[1] . 'x' . $picinfo[0] . 'px, ' . $format . '[/i])[/url]',
                        $content
                    );
                    ...
                    $content = str_ireplace(
                        ...
                        '[/b]<br />(' . $picinfo[1] . 'x' . $picinfo[0] . 'px, ' . $format . ')[/url]',
                        $content
                    );
                } else {
