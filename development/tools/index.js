...
Nightwatch.prototype.setOptions = function(options) {
  ...
  var username = this.api.username = this.options.username;
  var key = this.api.accessKey = this.options.accessKey || this.options.access_key || this.options.password;

  this.api.options = {
    launch_url     : this.api.launchUrl,
