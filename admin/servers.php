...
if ($action == "add") {
    ...
    echo '<form method="post" id="post" name="post" action="admincenter.php?site=servers"
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr>
            <td colspan="2" valign="top"><b>' . $_language->module[ 'info' ] . '</b>
                ...
                <textarea id="message" name="message" rows="5" cols="" style="width: 100%;"></textarea>
            </td>
        </tr>
        <tr>
            <td colspan="2">
              <input type="hidden" name="captcha_hash" value="' . $hash . '">
              <input type="submit" name="save" value="' . $_language->module[ 'add_server' ] . '">
            </td>
        </tr>
    </table>
    </form>';
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td colspan="2" valign="top"><b>' . $_language->module[ 'info' ] . '</b>
        ...
        <br /><textarea id="message" name="message" rows="5" cols="" style="width: 100%;">' . getinput($ds[ 'info' ]) .
        '</textarea>
      </td>
    </tr>
    <tr>
      <td colspan="2"><input type="hidden" name="serverID" value="' . $serverID .
        '" /><input type="hidden" name="captcha_hash" value="' . $hash .
        '" /><input type="submit" name="saveedit" value="' . $_language->module[ 'edit_server' ] . '" /></td>
    </tr>
  </table>
  </form>';
} else {
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#DDDDDD">
      <tr>
        ...
        echo '<tr>
        <td colspan="3" class="td_head" align="right"><input type="hidden" name="captcha_hash" value="' . $hash .
            '"><input type="submit" name="sort" value="' . $_language->module[ 'to_sort' ] . '" /></td>
      </tr>
    </table>
    </form>';
    } else {
