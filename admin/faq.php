...
if (isset($_GET[ 'action' ])) {
    if ($_GET[ 'action' ] == "add") {
        ...
        echo '<form method="post" id="post" name="post" action="admincenter.php?site=faq"
        onsubmit="return chkFormular();">
        <table width="100%" border="0" cellspacing="1" cellpadding="3">
            <tr>
                <td width="15%">
                    <b>' . $_language->module[ 'category' ] . '</b>
                </td>
                <td width="85%">' . $faqcats . '</td>
            </tr>
            <tr>
                <td>
                    <b>' . $_language->module[ 'faq' ] . '</b>
                </td>
                <td>
                    <input type="text" name="question" value="' . $question . '" size="97" />
                </td>
            </tr>
                <tr>
                    <td>
                        <b>' . $_language->module[ 'tags' ] . '</b>
                    </td>
                    <td>
                        <input type="text" name="tags" value="" size="97" />
                    </td>
                </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="submit" name="save" value="' . $_language->module[ 'add_faq' ] . '">
                </td>
            </tr>
        </table>
        </form>';
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="3">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="submit" name="saveedit" value="' . $_language->module[ 'edit_faq' ] . '" />
                </td>
            </tr>
        </table>
    </form>';
    ...
    echo '<input type="button" onclick="MM_goToURL(\'parent\',\'admincenter.php?site=faq&amp;action=add\');
        return document.MM_returnValue" value="' . $_language->module[ 'new_faq' ] . '"><br><br>';
        ...
        while ($db = mysqli_fetch_array($faq)) {
            ...
            echo '<tr>
                ...
                <td class="' . $td . '" align="center">
                    <input type="button"
                        onclick="MM_goToURL(\'parent\',\'admincenter.php?site=faq&amp;action=edit&amp;faqID=' .
                        $db[ 'faqID' ] . '\');return document.MM_returnValue" value="' . $_language->module[ 'edit' ] .
                        '" />
                    <input type="button" onclick="MM_confirm(\'' . $_language->module[ 'really_delete' ] .
                        '\', \'admincenter.php?site=faq&amp;delete=true&amp;faqID=' . $db[ 'faqID' ] .
    ...
    echo '<tr>
      <td class="td_head" colspan="3" align="right"><input type="hidden" name="captcha_hash" value="' . $hash .
