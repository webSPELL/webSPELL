...
if ($action == "add") {
    ...
    echo '<h1>&curren; <a href="admincenter.php?site=modrewrite" class="white">' . $_language->module['modrewrite'] .
        '</a> &raquo; ' . $_language->module['add_rule'] . '</h1>';
    ...
    $hash = $CAPCLASS->getHash();
    echo '<h1>&curren; <a href="admincenter.php?site=modrewrite" class="white">' . $_language->module['modrewrite'] .
        '</a> &raquo; ' . $_language->module['edit_rule'] . '</h1>';
    ...
    echo
        '<a href="admincenter.php?site=modrewrite&amp;action=add" class="input">' . $_language->module['new_rule'] . '</a> ';
    echo
