      ...
      <tr>
        ...
        foreach ($updates as $value => $package) {
            ...
            if ($updateinfo[ 0 ] == "noupdates") {
                ...
                echo '<tr>
          <td class="td1"><a href="' . $updateserver . '?package=' . $updateinfo[ 0 ] . '" target="_blank">' .
                    $updateinfo[ 0 ] . '.php</a></td>
        ...
        echo '</table>
    <br /><br />&raquo; <a href="' . $updateserver . '?get=true" target="_blank"><b>' .
            $_language->module[ 'get_new_version' ] . '</b></a>';
    }
}
