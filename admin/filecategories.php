...
if ($_GET[ 'action' ] == "add") {
    ...
    echo '<form method="post" action="admincenter.php?site=filecategories">
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    echo '<form method="post" action="admincenter.php?site=filecategories" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    <tr>
      <td width="15%"><b>' . $_language->module[ 'category_name' ] . '</b></td>
    ...
    <tr>
      <td><input type="hidden" name="captcha_hash" value="' . $hash .
        '" /><input type="hidden" name="filecatID" value="' . $ds[ 'filecatID' ] . '" /></td>
