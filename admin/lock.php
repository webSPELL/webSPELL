...
echo '<h1>&curren; <a href="admincenter.php?site=settings" class="white">' . $_language->module[ 'settings' ] .
...
if (!$closed) {
    ...
    <b>' . $_language->module[ 'pagelock' ] . '</b><br /><small>' . $_language->module[ 'you_can_use_html' ] .
            '</small><br /><br />
    <textarea name="reason" rows="30" cols="" style="width: 100%;">' . getinput($ds[ 'reason' ]) .
