...
if (isset($_GET[ 'action' ])) {
    if ($_GET[ 'action' ] == "addcat") {
        ...
        echo '<form method="post" action="admincenter.php?site=faqcategories" id="post" name="post"
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr>
            <td colspan="2"><b>' . $_language->module[ 'description' ] . '</b>
                ...
                <textarea id="message" rows="10" cols="" name="message" style="width: 100%;"></textarea>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <input type="hidden" name="captcha_hash" value="' . $hash . '">
                <input type="submit" name="savecat" value="' . $_language->module[ 'add_category' ] . '">
            </td>
        </tr>
    </table>
    </form>';
...
onsubmit="return chkFormular();">
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr>
            <td width="15%"><b>' . $_language->module[ 'category_name' ] . '</b></td>
            <td width="85%">
                <input type="text" name="faqcatname" size="60" value="' . getinput($ds[ 'faqcatname' ]) . '">
            </td>
        </tr>
      <tr>
        <td colspan="2"><b>' . $_language->module[ 'description' ] . '</b>
	        ...
	        <br /><textarea id="message" rows="10" cols="" name="message" style="width: 100%;">' .
            getinput($ds[ 'description' ]) . '</textarea>
	      </td>
      </tr>
      <tr>
        <td colspan="2"><input type="hidden" name="captcha_hash" value="' . $hash .
            '" /><input type="hidden" name="faqcatID" value="' . $faqcatID .
            '" /><input type="submit" name="saveeditcat" value="' . $_language->module[ 'edit_category' ] . '" /></td>
      </tr>
    </table>
    </form>';
    }
