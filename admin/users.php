...
if ($action == "activate") {
        ...
        if (!issuperadmin($id) or (issuperadmin($id) and issuperadmin($userID))) {
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="3">
			  ...
			  <tr id="until_date" ' . $hide . '>
			    ...
			    <td><input type="text" name="u_day" onchange="kill_form(\'until\');" id="u_day" size="2" value="' .
                $u_day .
                ...
                $u_year . '" /> <i>dd.mm.YY</i></td>
			  </tr>
			  <tr id="ban_for" ' . $hide . '>
			    <td><b>' . $_language->module[ 'ban_for' ] . ':</b></td>
			    <td><input type="text" name="ban_num" onchange="kill_form(\'\');" id="ban_num" size="3" />
			    <select name="ban_multi"><option value="1">' .
                $_language->module[ 'days' ] . '</option><option value="7">' . $_language->module[ 'weeks' ] .
                '</option><option value="28">' . $_language->module[ 'month' ] . '</option></select></td>
			  </tr>
			  <tr>
			    <td><b>' . $_language->module[ 'permanently' ] . '</b></td>
			    <td><input type="checkbox" id="permanent" onchange="hide_forms();" value="1" name="permanent" ' .
                $checked . ' /></td>
			  </tr>
			  <tr>
    ...
    echo '<form method="post" action="admincenter.php?site=users&amp;page=' . (int)$_GET[ 'page' ] . '&amp;type=' .
        getforminput($_GET[ 'type' ]) . '&amp;sort=' . $_GET[ 'sort' ] . '">
	<table width="100%" border="0" cellspacing="1" cellpadding="3">
    <tr>
      <td width="15%"><b>' . $_language->module[ 'nickname' ] . '</b></td>
      <td width="85%">' . $nickname . '</td>
    ...
    <tr>
      ...
      <td><input type="radio" name="activity" value="1" checked="checked" /> ' . $_language->module[ 'active' ] .
        ' &nbsp; <input type="radio" name="activity" value="0" /> ' . $_language->module[ 'inactive' ] . '</td>
    </tr>
    <tr>
    ...
    echo '<h1>&curren; <a href="admincenter.php?site=users" class="white">' . $_language->module[ 'users' ] .
        '</a> &raquo; ' . $_language->module[ 'add_new_user' ] . '</h1>';
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#DDDDDD">
      <tr>
        <td width="16%" class="title"><a href="admincenter.php?site=users&amp;type=' . $type .
            '&amp;sort=registerdate&amp;page=' . $page . '&amp;type=' . $type . '&amp;search=' . $search . '"><b>' .
            $_language->module[ 'registered_since' ] . '</b></a></td>
        <td width="22%" class="title"><a href="admincenter.php?site=users&amp;type=' . $type .
            '&amp;sort=nickname&amp;page=' . $page . '&amp;type=' . $type . '&amp;search=' . $search . '"><b>' .
            $_language->module[ 'nickname' ] . '</b></a></td>
        <td width="17%" class="title"><a href="admincenter.php?site=users&amp;type=' . $type .
            '&amp;sort=status&amp;page=' . $page . '&amp;type=' . $type . '&amp;search=' . $search . '"><b>' .
            $_language->module[ 'status' ] . '</b></a></td>
        ...
        <td class="' . $td . '"><a href="../index.php?site=profile&amp;id=' . $id . '" target="_blank">' .
        ...
        <td class="' . $td . '" align="center" width="6%"><input type="button" onclick="MM_confirm(\'' .
                $_language->module[ 'really_delete' ] . '\', \'admincenter.php?site=users&amp;page=' . $page .
        ...
        echo '</table>
    <br /><br />&raquo; <a href="admincenter.php?site=users&amp;action=adduser"><b>' .
