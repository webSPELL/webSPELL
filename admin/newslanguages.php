...
if ($action == "add") {
    ...
    echo '<h1>&curren; <a href="admincenter.php?site=newslanguages" class="white">' .
        $_language->module[ 'news_languages' ] . '</a> &raquo; ' . $_language->module[ 'add_language' ] . '</h1>';
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr>
            ...
            <td>
                <select name="lang" onchange="document.getElementById(\'getcountry\').
                src=\'../images/flags/\'+this.options[this.selectedIndex].value+\'.gif\'">' .
        $langs . '</select> &nbsp; ' . $_language->module[ 'preview' ] . ': ' . $country . '</td>
        </tr>
        <tr>
    ...
    echo '<h1>&curren; <a href="admincenter.php?site=newslanguages" class="white">' .
        $_language->module[ 'news_languages' ] . '</a> &raquo; ' . $_language->module[ 'edit_language' ] . '</h1>';
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr>
            <td width="15%"><b>' . $_language->module[ 'language' ] . '</b></td>
            <td width="85%">
                <input type="text" name="language" value="' . getinput($ds[ 'language' ]) . '" size="60" />
            </td>
        </tr>
        <tr>
            <td width="15%"><b>' . $_language->module[ 'title' ] . '</b></td>
        ...
        <tr>
            <td><b>' . $_language->module[ 'flag' ] . '</b></td>
            <td><select name="lang" onchange="document.getElementById(\'getcountry\').
            src=\'../images/flags/\'+this.options[this.selectedIndex].value+\'.gif\'">' .
        $langs . '</select> &nbsp; ' . $_language->module[ 'preview' ] . ': ' . $country . '</td>
        </tr>
        <tr>
            <td><input type="hidden" name="captcha_hash" value="' . $hash .
        '"><input type="hidden" name="langID" value="' . $ds[ 'langID' ] . '" /></td>
