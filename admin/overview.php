...
echo $_language->module[ 'hello' ] . '&nbsp;' . $username . ',&nbsp;' . $_language->module[ 'last_login' ] . '&nbsp;' .
    $lastlogin . '.<br /><br />';
...
<iframe
    ...
    ?>"
    height="70" frameborder="0" scrolling="no" width="100%"></iframe><br/><br/>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#DDDDDD">
    ...
    <tr>
        <td class="td1" colspan="4"><b><?php echo $_language->module[ 'legend' ]; ?>:</b>&nbsp; &nbsp;<font
                color="#008000"><?php echo $_language->module[ 'green' ]; ?>
                :</font> <?php echo $_language->module[ 'setting_ok' ]; ?>&nbsp; - &nbsp;<font
                color="#FFA500"><?php echo $_language->module[ 'orange' ]; ?>
                :</font> <?php echo $_language->module[ 'setting_notice' ]; ?>&nbsp; - &nbsp;<font
                color="#FF0000"><?php echo $_language->module[ 'red' ]; ?>
                :</font> <?php echo $_language->module[ 'setting_error' ]; ?></td>
    </tr>
    <tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#DDDDDD">
    ...
    <tr>
        ...
        <td width="75%" colspan="3" class="td2"><?php
            echo $get_gdtypes . '</td></tr></table>';
