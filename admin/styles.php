...
if (isset($_POST[ 'submit' ])) {
    ...
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
        ...
        if (!(preg_match($sem, $_POST[ 'borderc' ]))) {
            $error[ ] = $_language->module[ 'error_bordercolor' ];
        }
        if (!(preg_match($sem, $_POST[ 'head' ]))) {
            $error[ ] = $_language->module[ 'error_head_bg' ];
        }
        if (!(preg_match($sem, $_POST[ 'cat' ]))) {
	...
	<br /><br />
	<b>' . $_language->module[ 'stylesheet' ] . '</b><br /><small>' . $_language->module[ 'stylesheet_info' ] .
        '</small><br><br>
