...
if (isset($_POST[ 'submit' ])) {
    ...
    echo '
    <form method="post" id="post" name="post" action="admincenter.php?site=imprint" onsubmit="return chkFormular();">
      ...
      <b>' . $_language->module[ 'imprint' ] . '</b><br /><small>' . $_language->module[ 'you_can_use_html' ] .
        '</small><br /><br />';
    ...
    echo '<br /><textarea id="message" name="message" rows="30" cols="" style="width: 100%;">' .
        getinput($ds[ 'imprint' ]) . '</textarea><br /><br /><input type="hidden" name="captcha_hash" value="' . $hash .
        '" />
