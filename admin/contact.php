...
if (isset($_GET[ 'action' ])) {
    if ($_GET[ 'action' ] == "add") {
        ...
        echo '<h1>&curren; <a href="admincenter.php?site=contact" class="white">' . $_language->module[ 'contact' ] .
            '</a> &raquo; ' . $_language->module[ 'add_contact' ] . '</h1>';
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="3">
            ...
            '" /><input type="submit" name="save" value="' . $_language->module[ 'add_contact' ] . '" /></td>
			</tr>
		</table>
		</form>';
        ...
        echo '<h1>&curren; <a href="admincenter.php?site=contact" class="white">' . $_language->module[ 'contact' ] .
            '</a> &raquo; ' . $_language->module[ 'edit_contact' ] . '</h1>';
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="3">
			...
			<tr>
				<td colspan="2"><input type="hidden" name="captcha_hash" value="' . $hash .
            '"><input type="hidden" name="contactID" value="' . getforminput($contactID) .
            '" /><input type="submit" name="saveedit" value="' . $_language->module[ 'edit_contact' ] . '" /></td>
			</tr>
		</table>
		</form>';
    }
    ...
    echo '<tr>
            <td class="td_head" colspan="4" align="right">
                <input type="hidden" name="captcha_hash" value="' . $hash . '">
                <input type="submit" name="sortieren" value="' . $_language->module[ 'to_sort' ] . '">
            </td>
        </tr>
    </table>
    </form>';
