...
if(isset($_POST['submit'])) {
	...
	if($CAPCLASS->check_captcha(0, $_POST['captcha_hash'])) {
		safe_query("UPDATE ".PREFIX."settings SET hpurl='".$_POST['url']."',
									 ...
									 spam_check='".intval($_POST['spam_check'])."',
									 spamapiblockerror='".intval($_POST['spamapiblockerror'])."',
									 detect_language='".intval($_POST['detectLanguage'])."',
