...
if ($action == "add") {
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    if (file_exists($filepath . $ds[ 'bannerID' ] . '.gif')) {
        $pic = '<img src="../images/bannerrotation/' . $ds[ 'bannerID' ] . '.gif" alt="' . $ds[ 'banner' ] . '">';
    } elseif (file_exists($filepath . $ds[ 'bannerID' ] . '.jpg')) {
        $pic = '<img src="../images/bannerrotation/' . $ds[ 'bannerID' ] . '.jpg" alt="' . $ds[ 'banner' ] . '">';
    } elseif (file_exists($filepath . $ds[ 'bannerID' ] . '.png')) {
        $pic = '<img src="../images/bannerrotation/' . $ds[ 'bannerID' ] . '.png" alt="' . $ds[ 'banner' ] . '">';
    } else {
