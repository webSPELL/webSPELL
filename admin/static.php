...
-->
    ...
    echo '<form method="post" id="post" name="post" action="admincenter.php?site=static" enctype="post"
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
	...
	<tr>
		...
		<td><input name="accesslevel" type="radio" value="0" checked="checked" /> ' . $_language->module[ 'public' ] .
        '<br />
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
	...
	<tr>
		<td><b>' . $_language->module[ 'accesslevel' ] . '</b></td>
		<td><input name="accesslevel" type="radio" value="0" ' . $public . ' /> ' . $_language->module[ 'public' ] .
        '<br />
        ...
        $_language->module[ 'clanmember_only' ] . '</td>
		</tr>
	</table>
	<br /><b>' . $_language->module[ 'content' ] . '</b><br /><small>' . $_language->module[ 'you_can_use_html' ] .
        '</small><br /><br />';
...
<input type="submit" name="save" value="' . $_language->module[ 'edit_static_page' ] . '" />
    ...
    while ($ds = mysqli_fetch_array($ergebnis)) {
        ...
        echo '<tr>
            ...
            <td class="' . $td . '"><a href="../index.php?site=static&amp;staticID=' . $ds[ 'staticID' ] .
