...
$step = Input::validFromGet('step', Input::Int);
if ($step === null || $step > 6 || $step < 1) {
    $step = 0;
...
<table border="0" cellpadding="0" cellspacing="0" width="776" align="center">
    ...
    <?php
    echo '<tr><td colspan="2"><form action="index.php?step=' . $next_step .
        '" method="post" name="ws_install"></td></tr>';
