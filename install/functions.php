...
function update40200_40300() {
  ...
  mysqli_query($_database,"INSERT INTO `".PREFIX."modrewrite` (`regex`, `link`, `fields`, `replace_regex`, `replace_result`, `rebuild_regex`, `rebuild_result`) VALUES('buddys.html','index.php?site=buddys','a:0:{}','index\\\\.php\\\\?site=buddys','buddys.html','buddys\\\\.html','index.php?site=buddys')");
  ...
  mysqli_query($_database,"INSERT INTO `".PREFIX."modrewrite` (`regex`, `link`, `fields`, `replace_regex`, `replace_result`, `rebuild_regex`, `rebuild_result`) VALUES('cashbox.html','index.php?site=cash_box','a:0:{}','index\\\\.php\\\\?site=cash_box','cashbox.html','cashbox\\\\.html','index.php?site=cash_box')");
  mysqli_query($_database,"INSERT INTO `".PREFIX."modrewrite` (`regex`, `link`, `fields`, `replace_regex`, `replace_result`, `rebuild_regex`, `rebuild_result`) VALUES('cashbox/{id}.html','index.php?site=cash_box&id={id}','a:1:{s:2:\"id\";s:7:\"integer\";}','index\\\\.php\\\\?site=cash_box[&|&amp;]*id=([0-9]+)','cashbox/$3.html','cashbox\\\\/([0-9]+?)\\\\.html','index.php?site=cash_box&id=$1')");
  mysqli_query($_database,"INSERT INTO `".PREFIX."modrewrite` (`regex`, `link`, `fields`, `replace_regex`, `replace_result`, `rebuild_regex`, `rebuild_result`) VALUES('cashbox/action.html','cash_box.php','a:0:{}','cash_box\\\\.php','cashbox/action.html','cashbox\\\\/action\\\\.html','cash_box.php')");
  mysqli_query($_database,"INSERT INTO `".PREFIX."modrewrite` (`regex`, `link`, `fields`, `replace_regex`, `replace_result`, `rebuild_regex`, `rebuild_result`) VALUES('cashbox/delete/{id}.html','cash_box.php?delete=true&id={id}','a:1:{s:2:\"id\";s:7:\"integer\";}','cash_box\\\\.php\\\\?delete=true[&|&amp;]*id=([0-9]+)','cashbox/delete/$3.html','cashbox\\\\/delete\\\\/([0-9]+?)\\\\.html','cash_box.php?delete=true&id=$1')");
  mysqli_query($_database,"INSERT INTO `".PREFIX."modrewrite` (`regex`, `link`, `fields`, `replace_regex`, `replace_result`, `rebuild_regex`, `rebuild_result`) VALUES('cashbox/edit/{id}.html','index.php?site=cash_box&action=edit&id={id}','a:1:{s:2:\"id\";s:7:\"integer\";}','index\\\\.php\\\\?site=cash_box[&|&amp;]*action=edit[&|&amp;]*id=([0-9]+)','cashbox/edit/$3.html','cashbox\\\\/edit\\\\/([0-9]+?)\\\\.html','index.php?site=cash_box&action=edit&id=$1')");
  mysqli_query($_database,"INSERT INTO `".PREFIX."modrewrite` (`regex`, `link`, `fields`, `replace_regex`, `replace_result`, `rebuild_regex`, `rebuild_result`) VALUES('cashbox/new.html','index.php?site=cash_box&action=new','a:0:{}','index\\\\.php\\\\?site=cash_box[&|&amp;]*action=new','cashbox/new.html','cashbox\\\\/new\\\\.html','index.php?site=cash_box&action=new')");
  mysqli_query($_database,"INSERT INTO `".PREFIX."modrewrite` (`regex`, `link`, `fields`, `replace_regex`, `replace_result`, `rebuild_regex`, `rebuild_result`) VALUES('cashbox/new.html','index.php?site=cash_box&action=new','a:0:{}','index\\\\.php\\\\?site=cash_box[&|&amp;]*action=new','cashbox/new.html','cashbox\\\\/new\\\\.html','index.php?site=cash_box&action=new')");
