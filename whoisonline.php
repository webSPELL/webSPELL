...
if($type=="ASC"){
	$sorter='<a href="index.php?site=whoisonline&amp;sort='.$sort.'&amp;type=DESC">'.$_language->module['sort'].'</a> <img src="images/icons/asc.gif" width="9" height="7" alt="">';
}
else{
	$sorter='<a href="index.php?site=whoisonline&amp;sort='.$sort.'&amp;type=ASC">'.$_language->module['sort'].'</a> <img src="images/icons/desc.gif" width="9" height="7" alt="">';
}
...
while($ds=mysqli_fetch_array($ergebnis)) {
	...
	if($ds['ip']=='') {
		...
		else $email='<a href="mailto:'.mail_protect(getemail($ds['userID'])).'"><img src="images/icons/email.gif" width="15" height="11" alt="e-mail"></a>';

		$country='[flag]'.getcountry($ds['userID']).'[/flag]';
		$country=flags($country);

		if(!validate_url(gethomepage($ds['userID']))) $homepage='';
		else $homepage='<a href="'.gethomepage($ds['userID']).'" target="_blank"><img src="images/icons/hp.gif" width="14" height="14" alt="homepage"></a>';
