  ...
  if(!empty($ds['screens'])) $screens=explode("|", $ds['screens']);
	if(is_array($screens)) {
		...
		foreach($screens as $screen) {
			if(!empty($screen)) {
				$screenshots.='<a href="images/clanwar-screens/'.$screen.'" target="_blank"><img src="images/clanwar-screens/'.$screen.'" width="150" height="100" style="padding-top:3px; padding-right:3px;"></a>';
				if($nbr==2) {
					$nbr=1;
					$screenshots.='<br />';
				} else {
