...
/* do not edit above this line */
  ...
  'articles'=>'статия',
  'author'=>'автор',
  'bbcode'=>'&#8226; <a href="javascript:MM_openBrWindow(\'code.php\',\'BBCode\',\'scrollbars=yes,width=600,height=500\')">ББКод</a> <b><u>е включен</u></b>',
  'cancel'=>'отказ',
  'date'=>'дата',
  'delete'=>'изтриване',
  'edit'=>'редакция',
  ...
  'new_article'=>'нова статия',
  'new_window'=>'нов прозорец',
  'no_access'=>'достъп отказан',
  'no_comments'=>'деактивирани коментари',
  'no_entries'=>'Не може да се въвежда!',
  'options'=>'опции',
  'page'=>'страница',
  ...
  'poor'=>'лош',
  'rate'=>'оцени',
  'rate_with'=>'Оценете от 0 до 10 точки',
  'rating'=>'оценка',
  'really_delete'=>'Наистина искате да изтриете статията?',
  'save_article'=>'запиши статията',
  'self'=>'същия прозорец',
  'smilies'=>'&#8226; <a href="javascript:MM_openBrWindow(\'smileys.php\',\'Smileys\',\'scrollbars=yes,width=340,height=500\')">Усмивки</a> <b><u>е включен</u></b>',
  'sort'=>'подреди:',
  'title'=>'заглавие',
  'top5_points'=>'ТОП 5 СТАТИИ (точки)',
  'top5_rating'=>'ТОП 5 СТАТИИ (рейтинг)',
  'upload_images'=>'качи снимка',
  'user_comments'=>'разрешени коментари',
  'viewed'=>'видян',
