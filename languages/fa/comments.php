...
/* do not edit above this line */
  ...
  'bbcode_on'=>'<a href="javascript:void(0);" onclick="window.open(\'code.php\',\'BBCode\',\'scrollbars=yes,width=600,height=500\')">BBCode</a> به وسیله',
  'by'=>'به وسیله',
  ...
  'error_nickname'=>'!این نام قبلا انتخاب شده',
  'homepage'=>'صفحه نخست',
  ...
  'smilies_on'=>'<a href="javascript:void(0);" onclick="window.open(\'smileys.php\',\'Smileys\',\'scrollbars=yes,width=340,height=500\')">شکلک ها</a> به وسیله',
  'sort'=>'انتخاب بر حسب:',
