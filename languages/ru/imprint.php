...
/* do not edit above this line */
  ...
  'admins'=>'Администратор(ы):',
  'coding'=>'Программное обеспечение',
  'coding_info'=>'Это сайт использует <a href="http://www.webspell.org" target="_blank">webSPELL Free Content Management System (version: $version)</a>. Он основан на PHP4/5 и MySQL и работает под <a href="http://www.fsf.org/licensing/licenses/gpl.html" target="_blank">GNU GENERAL PUBLIC LICENSE</a>.<br>Доступна бесплатно по этой ссылке: <a href="http://www.webspell.org" target="_blank">www.webSPELL.org</a>',
