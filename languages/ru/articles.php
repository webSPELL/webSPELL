...
/* do not edit above this line */
  ...
  'articles'=>'Статьи',
  'author'=>'Автор',
  'bbcode'=>'&#8226; <a href="javascript:window.open(\'code.php\',\'BBCode\',\'scrollbars=yes,width=600,height=500\')">BBКод</a> <b><u>включено</u></b>',
  'cancel'=>'Отменить',
  'date'=>'Дата',
  'delete'=>'Удалить',
  'edit'=>'Редактировать',
  ...
  'self'=>'в том же окне',
  'smilies'=>'&#8226; <a href="javascript:window.open(\'smileys.php\',\'Smileys\',\'scrollbars=yes,width=340,height=500\')">Смайлы</a> <b><u>включено</u></b>',
  'sort'=>'Сортировать:',
  'title'=>'Наслов',
