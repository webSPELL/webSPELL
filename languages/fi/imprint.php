...
/* do not edit above this line */
  ...
  'admins'=>'Ylläpitäjä(t):',
  'coding'=>'Ohjelmoijat',
  'coding_info'=>'Tämä sivusto käyttää <a href="http://www.webspell.org" target="_blank">webSPELL Free Content Management System (version: $version)</a>. Se perustuu PHP4/5 and MySQL ja käynnissä <a href="http://www.fsf.org/licensing/licenses/gpl.html" target="_blank">GNU GENERAL PUBLIC LICENSE</a>.<br />Saada sen ilmaiseksi tästä paikasta: <a href="http://www.webspell.org" target="_blank">www.webSPELL.org</a>',
  ...
  'imprint'=>'Valmistusmerkintä',
  'mods'=>'Välittäjä(t):',
  'responsible_persons'=>'Vastuulliset henkilöt',
  'webmaster'=>'Webmaster:'
);
?>