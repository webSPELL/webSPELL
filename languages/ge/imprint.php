...
/* do not edit above this line */
  ...
  'admins'=>'ადმინისტრატორი(ები):',
  'coding'=>'პროგრამული მომწახურება',
  'coding_info'=>'ეს საიტი იყენებს <a href="http://www.webspell.org" target="_blank">webSPELL Free Content Management System (version: $version)</a>.ეს ჩამოყალიბებულია PHP4/5 და MySQL და მუშაობს  <a href="http://www.fsf.org/licensing/licenses/gpl.html" target="_blank">GNU GENERAL PUBLIC LICENSE</a>.<br>უფასოდა ხელმისაწვდომი შემდეგ ბმულზე: <a href="http://www.webspell.org" target="_blank">www.webSPELL.org</a>',
  'disclaimer'=>'დისკლეიმერი',
  ...
  'imprint'=>'მონაცემები',
  'mods'=>'მოდერატორი(ები):',
  'responsible_persons'=>'პასუხისმგებელი პირები',
  'webmaster'=>'ვებმასტერი:'
);
?>