...
/* do not edit above this line */
	...
	Autorius nėra atsakingas už bet kokį turinį, kviečiamus ar paminėtus iš jo puslapių - nebent jei jis žino, kad tai yra nelegalus turinys, tada jis galėtų sutrukdyti lankytojams peržiūrėti tą turinį. Jei koks nors pakenkimas įvyksta vartojant informaciją, pristatytą ten, tiktai atitinkamų puslapių autorius galėtų būti atsakingas, ne tas, kuris prisijungė prie šitų puslapių. Be to autorius nėra atsakingas už bet kokį registravimą ar žinutes, publikuotas vartotojų diskusijosė, svečių knyguose ar asmeniniuose žinutėse, pateikto ant jo puslapio.</p>
	<p><strong>3. Visos teisės</strong><br>
	Autorius ketino nenaudoti jokios autorinės teisės apsaugotos medžiagos publikacijai ar, jei negalimas, tada jis gali įdėti nuorodą iš kur paimta medžiaga. Autorystės teisės bet kokiai medžiagai, sukurtai autoriaus, egzsituoja visada. Bet koks kopijavimas ar naudojimas objektų tokių kaip atvaizdai, diagramos, garsai ar tekstai kitose puslapiuose ar atspausdintose publikacijose nėra leistina be autoriaus sutikimo.</p>
	<p><strong>4. Privatumo politika</strong><br>
