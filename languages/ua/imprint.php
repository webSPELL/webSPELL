...
/* do not edit above this line */
  ...
  'admins'=>'Адміністратор(и):',
  'coding'=>'програмне забезпечення',
  'coding_info'=>'Це сайт використовує <a href="http://www.webspell.org" target="_blank"> webSPELL Free Content Management System (version: $ version)</a>. Він заснований на PHP4/5 і MySQL і працює під<a href="http://www.fsf.org/licensing/licenses/gpl.html" target="_blank">GNU GENERAL PUBLICLICENSE</a>.<br />Доступна безкоштовно за цим посиланням: <a href="http://www.webspell.org" target="_blank">www.webSPELL.org</a>',
  'disclaimer'=>'Дісклеймер',
